...
ggsave(paste0(out,"Cor_White_Poverty.pdf"), width = 8, height = 5)
...
p1 + geom_point(aes(color = WhiteHI_Rec)) +
  ...
  geom_smooth(method = "lm")
ggsave(paste0(out,"Cor_White_highskill.pdf"), width = 8, height = 5)
...
ggsave(paste0("Cor_White_college.pdf"), width = 8, height = 5)
...
p1 + geom_point(aes(color = WhiteHI_Rec)) +
  ...
  geom_smooth(method = "lm")
ggsave(paste0("Cor_White_School.pdf"), width = 8, height = 5)
...
p1 + geom_point(aes(color = WhiteHI_Rec)) +
  ...
  geom_smooth(method = "lm")
ggsave(paste0("Cor_White_assault.pdf"), width = 8, height = 5)
...
p1 + geom_point(aes(color = WhiteHI_Rec)) +
  ...
  geom_smooth(method = "lm")
ggsave(paste0("Cor_White_Superfund.pdf"), width = 8, height = 5)
...
p1 + geom_point(aes(color = WhiteHI_Rec)) +
  ...
  geom_smooth(method = "lm")
ggsave(paste0("Cor_White_RSEI.pdf"), width = 8, height = 5)
