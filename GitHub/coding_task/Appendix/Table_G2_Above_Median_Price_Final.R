...
recs_trial_final = subset(recs_trial_final, AdPrice > 245000)
...
###Test Scores
#############################################################################################################################################################################
recs_trial_final_2 <- readRDS(paste0(in_dir, "HUDprocessed_JPE_testscores_042021.rds"))

recs_trial_final_2$highprice_Ad <- 0
recs_trial_final_2$highprice_Ad[recs_trial_final_2$AdPrice > 245000] <- 1
recs_trial_final_2 = subset(recs_trial_final_2, AdPrice > 245000)
...
stargazer( ED_elem4, ED_middle4, AS4, ES4,
           type = "latex",
           out = paste0(out, "HUM_tabG2_A.tex"),
...
stargazer(PR4, SK4, COL4, SF4, own4,
          type = "latex",
          out = paste0(out, "HUM_tabG2_B.tex"),
          title="Steering and Neighborhood Effects",
          model.numbers = F,
          keep = c("ofcolor"),
          covariate.labels = c("Racial Minority"),
...
stargazer(  ED_elem4_, ED_middle4_,AS4_, ES4_,
           type = "latex",
           out = paste0(out, "HUM_tabG1_A_.tex"),
           title="Steering and Neighborhood Effects",
...
stargazer(PR4_, SK4_, COL4_, SF4_, own4_,
          type = "latex",
          out = paste0(out, "HUM_tabG2_B_.tex"),
          title="Steering and Neighborhood Effects",
          dep.var.labels.include = F,
...
stargazer(SP4, RSEI4, PM4,
          type = "latex",
          out = paste0(out, "HUM_G2_polution.tex"),
          title="Steering and Neighborhood Effects",
          model.numbers = F,
          keep = c("ofcolor"),
          covariate.labels = c("Racial Minority"),
...
stargazer(SP4_, RSEI4_, PM4_,
          type = "latex",
          out = paste0(out, "HUM_G2_polution_.tex"),
          title="Steering and Neighborhood Effects",
          dep.var.labels.include = F,
