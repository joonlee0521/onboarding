...
homes.path <- paste0(in_dir, "adsprocessed_JPE.rds")
test.path <- paste0(in_dir, "HUDprocessed_JPE_testscores_042021.rds")
...
col_order <- c(
  "APRACE", "Price", "HHMTYPE.1", "HHMTYPE.2", "HHMTYPE.3", "HHMTYPE.4", "HHMTYPE.5",
