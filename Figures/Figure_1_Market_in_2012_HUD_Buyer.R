...
# MAPS
library(ggmap)
ggmap::register_stadiamaps("e7874288-14cb-43d2-83aa-7ee8642f5165")
...
recs <- readRDS(paste0(in_dir, "recsprocessed_JPE.rds"))
ads <- readRDS(paste0(in_dir, "adsprocessed_JPE.rds"))
...
US.map <- get_stadiamap(bbox, maptype = "stamen_terrain", zoom = 4)
