...
recs_trial_final_mothers <- within(recs_trial_final_mothers, {
  count <- ave(as.character(TESTERID), CONTROL, FUN = function(x) length(unique(x)))
})
...
recs_trial_final_MTO <- within(recs_trial_final_MTO, {
  count <- ave(as.character(TESTERID), CONTROL, FUN = function(x) length(unique(x)))
})
...
recs_trial_final_MTOmom <- within(recs_trial_final_MTOmom, {
  count <- ave(as.character(TESTERID), CONTROL, FUN = function(x) length(unique(x)))
})
...
recs_trial_final_MTOfam <- within(recs_trial_final_MTOfam, {
  count <- ave(as.character(TESTERID), CONTROL, FUN = function(x) length(unique(x)))
})
...
recs_trial_final_MTOhighdads <- within(recs_trial_final_MTOhighdads, {
  count <- ave(as.character(TESTERID), CONTROL, FUN = function(x) length(unique(x)))
})
...
recs_trial_final_MTOhighdadsfam <- within(recs_trial_final_MTOhighdadsfam, {
  count <- ave(as.character(TESTERID), CONTROL, FUN = function(x) length(unique(x)))
})
...
recs_trial_final_MTOhighdadsmom <- within(recs_trial_final_MTOhighdadsmom, {
  count <- ave(as.character(TESTERID), CONTROL, FUN = function(x) length(unique(x)))
})
...
df <- list(MTOpovrate_MTOsub_, MTOpovrate_MTOfamsub_, MTOpovrate_MTOmomssub_, MTOpovrateHighDad_, MTOpovrateHighDad_famsub_, MTOpovrateHighDad_momsub_)
stargazer(df,
  type = "latex",
